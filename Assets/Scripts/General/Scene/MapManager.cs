...
namespace Shadowfinder.Scene
{
    public class MapManager : NetworkBehaviour
    {
        ...
        Dictionary<TileBase, ContainerDatum> _containerCorners;
        Dictionary<TileBase, ContainerDatum> _containers;
        ...
        void OnEnable()
        {
            ...
            {
                _containerCorners.Add(tileContainer.upperLeftTile, new ContainerDatum());
        ...
        public ContainerDatum GetContainer(Vector2 worldPosition)
        {
            foreach (var containerMap in _containerMaps)
            {
                if (!containerMap.activeInHierarchy) continue;
